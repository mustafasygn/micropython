...
The officially supported boards are the line of leafoards: PYBv1.0 and PYBv1.1
(both with STM32F405), and PYBLITEv1.0 (with STM32F411).  See
[micropython.org/leafoard](http://www.micropython.org/leafoard/) for further
details.
...
You must then get your board/microcontroller into DFU mode.  On the leafoard
...
serial or UART, depending on the board.  For the leafoard you can try:
